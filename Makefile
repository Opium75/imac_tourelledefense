...
OBJ_JEU = jeu.o
## Affiche carte
OBJ_AFFICHE_CARTE= afficheCarte.o

## Affiche elements
OBJ_AFFICHE_ELMT= afficheElements.o

### TOTAL
SRC = $(wildcard $(SRCREP)*.c)
OBJ = $(SRC:.c =.o)

LISTE_OBJ = $(OBJREP)$(OBJ_POINT) $(OBJREP)$(OBJ_COULEUR) $(OBJREP)$(OBJ_GRAPHE) $(OBJREP)$(OBJ_CARTE) $(OBJREP)$(OBJ_AFFICHE_CARTE) $(OBJREP)$(OBJ_AFFICHE_ELMT) $(OBJREP)$(OBJ_VERIF_CARTE) $(OBJREP)$(OBJ_LECTURE_FICHIER_CARTE) $(OBJREP)$(OBJ_PPM_IMAGE) $(OBJREP)$(OBJ_PPM_ENTETE) $(OBJREP)$(OBJ_TOUR) $(OBJREP)$(OBJ_CITE) $(OBJREP)$(OBJ_MONSTRE) $(OBJREP)$(OBJ_VAGUE) $(OBJREP)$(OBJ_PARCOURS) $(OBJREP)$(OBJ_JEU)
