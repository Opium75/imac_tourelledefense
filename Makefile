...
LISTE_OBJ = $(OBJREP)$(OBJ_POINT) $(OBJREP)$(OBJ_COULEUR) $(OBJREP)$(OBJ_GRAPHE) $(OBJREP)$(OBJ_CARTE) $(OBJREP)$(OBJ_VERIF_CARTE) $(OBJREP)$(OBJ_LECTURE_FICHIER_CARTE) $(OBJREP)$(OBJ_PPM_IMAGE) $(OBJREP)$(OBJ_PPM_ENTETE) $(OBJREP)$(OBJ_TOUR) $(OBJREP)$(OBJ_MONSTRE)
